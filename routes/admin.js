  ...
  let products = [
    {
      ...
      image: "https://static.nike.com/a/images/t_PDP_936_v1/f_auto,q_auto:eco/fb7eda3c-5ac8-4d05-a18f-1c2c5e82e36e/BLAZER+MID+%2777+VNTG.png"
    },

    {
      ...
      image: "https://static.nike.com/a/images/c_limit,w_592,f_auto/t_product_v1/537a07d4-a2b7-471b-9506-cb9b50f1d8b8/W+NIKE+DUNK+LOW+NEXT+NATURE.png"
    },

    {
      ...
      image: "https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/4853cb6b-0ff1-49c4-a961-d03e206baab7/NIKE+COURT+VISION+LO.png"
    },
...
router.post('/add-products', (req, res) =>{
  productHelpers.addProduct(req.body).then((id) => {
    ...
    image.mv('./public/product-images/' +id + '.jpg', (err,callback) => {
      if(!err){
        res.render('admin/add-products')
      }else{
        console.log(err)
